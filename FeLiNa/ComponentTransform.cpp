...
{
	quat_rotation = quat_rotation * math::Quat::FromEulerXYZ(rot.x, rot.y, rot.z);
	euler_angles = quat_rotation.ToEulerXYZ();

	//euler_angles += rot;
	//quat_rotation = quat_rotation * math::Quat::FromEulerXYZ(euler_angles.x, euler_angles.y, euler_angles.z);
}
